    ...
    <div className="landing-page">
      ...
      <div className="landing-scroll-container">
        ...
        <section className="dashboard-preview-section">
          <div className="section-header">
            <span className="section-badge">Real-World SaaS Dashboard</span>
            <h2 className="section-title">Built-In Student Analytics</h2>
            <p className="section-subtitle">
              Monitor classroom results with our next-gen student management panel.
            </p>
          </div>
          ...
          <div className="dashboard-mockup">
            ...
            <div className="dash-header">
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: 'var(--color-indigo)' }} />
                <span style={{ fontSize: '0.85rem', fontWeight: 700 }}>MeanAI Dashboard</span>
              </div>
              
              <div className="dash-nav">
                <span className="dash-nav-item active">Overview</span>
                <span className="dash-nav-item">Classrooms</span>
                <span className="dash-nav-item">API Keys</span>
                <span className="dash-nav-item">Analytics</span>
              </div>

              <div className="dash-user">
                <div className="dash-user-avatar">NK</div>
                <span>Naveen Kumar</span>
              </div>
            </div>

            {/* Dashboard side navigation & main contents */}
            <div className="dash-body">
              <div className="dash-sidebar">
                <div className="dash-menu-group">
                  <span className="dash-menu-title">Main Menu</span>
                  <div className="dash-menu-item active">
                    <Laptop size={14} /> Overview
                  </div>
                  <div className="dash-menu-item">
                    <Brain size={14} /> Classrooms
                  </div>
                  <div className="dash-menu-item">
                    <Code size={14} /> Code Canvas
                  </div>
                </div>

                <div className="dash-menu-group">
                  <span className="dash-menu-title">Account</span>
                  <div className="dash-menu-item">
                    <Shield size={14} /> Security
                  </div>
                  <div className="dash-menu-item">
                    <Database size={14} /> Saved Traces
                  </div>
                </div>
              </div>
              ...
              <div className="dash-content">
                ...
                <div className="dash-main-pane">
                  ...
                  <div className="dash-stats-grid">
                    <div className="dash-stat-card">
                      <span className="dash-stat-label">Explanations Generated</span>
                      <div className="dash-stat-value">
                        <span>1,280</span>
                        <span className="dash-stat-trend">+12.5%</span>
                      </div>
                    </div>
                    
                    <div className="dash-stat-card">
                      <span className="dash-stat-label">Study Focus Hours</span>
                      <div className="dash-stat-value">
                        <span>42.8h</span>
                        <span className="dash-stat-trend" style={{ color: 'var(--color-cyan)' }}>+8.2h</span>
                      </div>
                    </div>

                    <div className="dash-stat-card">
                      <span className="dash-stat-label">Code Traces Solved</span>
                      <div className="dash-stat-value">
                        <span>94.2%</span>
                        <span className="dash-stat-trend">+3.4%</span>
                      </div>
                    </div>
                  </div>

                  {/* SVG Chart panel mockup */}
                  <div className="dash-chart-card">
                    <div className="dash-chart-header">
                      <span className="dash-chart-title">Classroom Activity Index</span>
                      <div className="dash-chart-legend">
                        <span><span className="legend-dot legend-dot-indigo" />Explanations Logged</span>
                      </div>
                    </div>

                    <div className="dash-chart-graphic">
                      ...
                      <svg width="100%" height="100%" viewBox="0 0 500 120" preserveAspectRatio="none">
                        ...
                        {/* Area graph */}
                        <path 
                          d="M 0 100 Q 80 50 160 80 T 320 20 T 480 40 L 480 120 L 0 120 Z" 
                          fill="url(#chartGlow)" 
                        />
                        {/* Line path */}
                        <path 
                          d="M 0 100 Q 80 50 160 80 T 320 20 T 480 40" 
                          fill="none" 
                  ...
                  <div className="dash-heatmap-card">
                    <h4 className="dash-heatmap-title">Daily Study Activity Heatmap</h4>
                    <div className="dash-heatmap-grid">
                      {Array.from({ length: 96 }).map((_, i) => {
                        const level = i % 11 === 0 ? 'level-4' : i % 7 === 0 ? 'level-3' : i % 5 === 0 ? 'level-2' : i % 3 === 0 ? 'level-1' : '';
                        return (
                          <div key={i} className={`heatmap-cell ${level}`} />
                        );
                      })}
                    </div>
                  </div>
                ...
                <div className="dash-side-pane">
                  ...
                  <div className="dash-progress-card">
                    <span className="dash-stat-label">Syllabus Completion</span>
                    <div className="dash-progress-circle-wrap">
                      <svg width="110" height="110">
                        <circle cx="55" cy="55" r="45" fill="none" stroke="rgba(255,255,255,0.02)" strokeWidth="8" />
                        <circle 
                          cx="55" 
                          cy="55" 
                          r="45" 
                      ...
                      <div className="dash-progress-text">
                        <span className="dash-progress-num">73%</span>
                        <span className="dash-progress-label">Complete</span>
                      </div>
                    </div>
                    <span style={{ fontSize: '0.78rem', color: '#64748b' }}>4/6 Classroom Units Complete</span>
                  </div>

                  {/* Active logs lists */}
                  <div className="dash-activity-list-card">
                    <h4 className="dash-activity-list-title">Recent Activity Logs</h4>
                    <div className="dash-activity-items">
                      {[
                        { text: "Explained fibonacci.py Recursion", time: "10m ago" },
                        { text: "Exported 'React Hooks' Presentation", time: "2h ago" },
                        { text: "Unlocked 'Control Flow' Unit", time: "1d ago" }
                      ].map((log, index) => (
                        <div key={index} className="dash-activity-item">
                          <span className="dash-activity-dot" />
                          <span className="dash-activity-text">{log.text}</span>
                          <span className="dash-activity-time">{log.time}</span>
                        </div>
                      ))}
                    </div>
                  </div>
